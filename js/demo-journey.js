/* Template Factory - Alfredo Perez live demo journey.
...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-alfredo-chino/';
  var LS_CHANGES = 'tf_alfredo_change_log_v1';
  var LS_PURCHASED = 'tf_alfredo_purchased_v1';
      ...
      apply: function () {
        if (heroLede) {
          heroLede.textContent =
            'Residential electrical, panel work, and wiring across Chino and the Inland Empire. You get a fixed itemised quote before we start, Alfredo as your named lead on site, and a twelve-month workmanship guarantee when we leave.';
        }
      }
    },
    {
  ...
  function setBarMode(mode) {
    ...
    if (!barSub) return;
    if (mode === 'updated') {
      barSub.textContent = 'Draft for Alfredo at Alfredo Perez. Claim it, preview the rest of the journey, or request a change.';
    } else {
      barSub.textContent = 'Draft for Alfredo at Alfredo Perez. Claim it, preview the rest of the journey, or request a change.';
    }
  }
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for Alfredo Perez. Hang tight.',
        delay,
        function () {
